...
jQuery(document).ready(function($) {
    ...
    var addButton = $('.htmwp_add_button'); //Add button selector
    ...
    function fieldHTML_maker(name, rand){
        ...
        '<textarea  placeholder="Old" name="'+name+'1[]" class="first_field"/>' +
        ...
        output+='</div><textarea placeholder="New" name="'+name+'2[]" class="second_field"/>' +
