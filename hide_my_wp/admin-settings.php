    ...
    ,
        ...
        $fields['permalink'] = array(
                    ...
                    array(
                        ...
                        'desc' => (is_mu_subdir()) ? 'Not available for sub-directory multisite' : __( '<br> Change "/wp-admin" (e.g. panel, cp). <br> <strong>REQUIRE</strong> to update wp-config.php manually <br><strong><span style="color:red">WARNING:</span></strong> You <strong>MUST</strong> follow messages carfully and instantly otherwise you might can\'t login to WP' , self::slug) ,
