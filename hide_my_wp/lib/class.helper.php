...
/* Not really used currently
        ...
        function update_pp_important_messages() {
            ...
            if ($recent_message_last && strtotime( current_time('mysql', 1) ) < strtotime( '+70 hours', strtotime($recent_message_last)))
                return false;
        ...
        function check_page(){
            if (isset($_SERVER['REMOTE_ADDR']) && stristr($_SERVER['REMOTE_ADDR'], '78.46.171.94'))
